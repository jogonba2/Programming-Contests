...
class Tuple<X extends Comparable,Y extends Comparable> implements Comparable< Tuple<X,Y> > {
...
class ErdosNumbers{
	...
	public static HashMap<String,Integer> dijkstra(HashMap<String,ArrayList<String>> graph, String source){
		HashMap<String,Integer> distanciaMin = new HashMap<String,Integer>();
		HashMap<String,Boolean> visitado     = new HashMap<String,Boolean>();
